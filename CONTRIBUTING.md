...
Open a github pull request with your proposed changes to this file (changes to the cost per life value or any other parameter, along with edits to the justification to support the edit).
...
If you don't want to go through the above process, and you have some information that you think would be useful to me for improving the site somehow, you can send feedback with [this form](https://forms.gle/NEC6LNics3n6WVo47).
