...
Several prominent AI researchers and lab leaders have publicly shared views that help calibrate the range, even though they often switch between extinction, catastrophe, disempowerment, and broad societal collapse. One notable signal: the CEOs of all three leading frontier labs — OpenAI, Google DeepMind, and Anthropic — publicly treat AI extinction risk as a serious concern, having all signed the 2023 [Statement on AI Risk](https://aistatement.com/): _"Mitigating the risk of extinction from AI should be a global priority alongside other societal-scale risks such as pandemics and nuclear war."_
