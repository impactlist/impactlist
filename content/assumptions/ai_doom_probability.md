...
Views vary enormously. But among people who have thought seriously about the issue, the center of gravity runs from the low single digits to the low double digits. Four bodies of evidence fix the anchors the 10% estimate is built around: broad surveys, forecasting tournaments, named-researcher statements, and a high-risk cluster.
...
Structured forecasting pulls lower. In the [Existential Risk Persuasion Tournament (XPT)](https://forecastingresearch.org/xpt) ([Karger et al. (2025)](https://forecastingresearch.org/s/XPT.pdf)), the median estimate for **AI-caused extinction by 2100** was about **0.38%** among superforecasters and **3%** among domain experts. Metaculus snapshots sit similarly low, around **1–5%** on AI-specific extinction. This is useful evidence against treating high estimates as consensus, but it is not decisive. Structured debate did not converge the two camps, and a later analysis found the superforecasters had no accuracy edge on resolved near-term questions, while both groups had underestimated AI progress.
...
Two patterns calibrate the middle of the range. First, the CEOs of all three leading frontier labs — OpenAI, Google DeepMind, and Anthropic — publicly treat AI extinction risk as a serious concern. They all signed the 2023 [Statement on AI Risk](https://aistatement.com/): _"Mitigating the risk of extinction from AI should be a global priority alongside other societal-scale risks such as pandemics and nuclear war."_ Second, two of the three "godfathers of deep learning" (the 2018 Turing Award co-winners whose work underpins modern LLMs) now treat catastrophic or extinction-level outcomes as significant: Hinton and Bengio. Only Yann LeCun is a prominent skeptic. Named point estimates in this group cluster around **10–25%** for the concerned researchers, with skeptics putting it near zero. These statements often switch between extinction, catastrophe, disempowerment, and broad collapse, so they calibrate the range rather than pin a number.
...
Some researchers assign significantly lower probabilities, often below 3%. Four arguments carry most of the weight. First, alignment is a **hard but ordinary engineering problem** for a designed artifact (LeCun), not uniquely impossible. Second, AI is **"normal technology"** that diffuses too slowly through institutions for a sudden uncontrollable takeover ([Narayanan and Kapoor](https://knightcolumbia.org/content/ai-as-normal-technology)). Third, **multiple intermediate stages** before superhuman systems give repeated chances for course correction. Fourth, the **XPT superforecaster anchors** (**0.38%** for AI-caused extinction) and a **historical track record** of over-pessimism about new technologies both argue against the higher estimates.
...
Other researchers assign significantly higher probabilities, often above 15%. Four arguments carry most of the weight. First, **fast, accelerating capability gains** have repeatedly surprised forecasters — METR finds the autonomous-task horizon [doubling every few months and accelerating](https://metr.org/blog/2026-1-29-time-horizon-1-1/), and forecasters [materially underestimated near-term progress](https://forecastingresearch.org/near-term-xpt-accuracy). Second, **competitive racing dynamics** make caution hard to coordinate. Third, there are **no second chances** if the first decisively capable system is misaligned. Fourth, the **difficulty of verifying alignment** persists, reinforced by the deception findings in Section 2. The 2026 [International AI Safety Report](https://internationalaisafetyreport.org/publication/international-ai-safety-report-2026) — a broad expert synthesis backed by 30+ governments — documents the same trajectory while stressing that reliable evaluation of frontier systems remains unsolved.

Important caveats cut the other way. Some benchmarks built to resist AI (such as ARC-AGI-2) remain hard, and real-world reliability still lags benchmark scores. The broad researcher surveys also did _not_ show a rising median: the share of Grace respondents giving extinction-level outcomes at least a 10% chance actually fell between the two surveys. Faster capabilities thus strengthen the case for taking the risk seriously, and for not over-trusting the lowest forecasts, without by themselves fixing a number.
...
- **30%** (the upper, 90th-percentile bound) is where it lands if the harder control arguments and racing dynamics dominate and the high camp is substantially right for extinction specifically. It sits above the most alarmed _moderate_ estimates. That is because our posterior puts real weight on the high-risk cluster described in Section 1.5 — where a credentialed minority places the risk far above this, up to near-certainty — not because most experts are there.
...
Estimates range from less than 10 years to well over 50 years. Shorter timelines tend to raise risk for two reasons. They leave less time for alignment, institutions, regulation, and safety research to mature ([Cotra](https://www.cold-takes.com/without-specific-countermeasures-the-easiest-path-to-transformative-ai-likely-leads-to-ai-takeover/); [McAleese](https://arxiv.org/abs/2209.05459)), and they make transformative AI more likely to arrive before 2100. A small survey of AI-safety researchers found a [weak negative correlation](https://forum.effectivealtruism.org/posts/LxuKuQd69Qx5FKhNZ/survey-of-ai-safety-leaders-on-x-risk-agi-timelines-and) between timelines and risk estimates. The link is not mechanical: some researchers argue that today's language-model paradigm may be [unusually controllable](https://optimists.ai/2023/11/28/ai-is-easy-to-control/) compared with older imagined RL-agent paths.
