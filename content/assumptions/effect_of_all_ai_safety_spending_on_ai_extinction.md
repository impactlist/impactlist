...
This page estimates how much cumulative AI safety-related spending through 2025 has changed the probability of **AI-caused human extinction** this century.
...
This is an **absolute risk reduction**. If current AI extinction risk is about **10%** ([detailed justification](/assumption/ai-doom-probability)), the best guess says past safety spending moved it from about **10.10%** to **10.0%**.

The range includes possible net harm because safety work may also have helped capabilities, sped up deployment, provided safetywashing, or strengthened racing labs.

In cost terms, the best guess is about **\$1.6 million per microprobability**, or **\$160 million per basis point**. A **basis point** (bp) is 0.01 percentage points, so the 0.10 percentage-point best guess is 10 bp. These figures use about **\$1.6 billion** of serious, non-lab-equivalent spending (Section 3). Conditional on the effect being positive, the plausible cost range is roughly **\$250,000–\$80 million per microprobability**. Counting all **\$2.6 billion** of raw spending equally gives about **\$2.6 million per microprobability**.

---

## 1. How we estimate this

There is no clean empirical way to observe the world without past AI safety spending, so we anchor the estimate two ways:

- what cost-effectiveness research implies good safety work can achieve, expressed as **basis points of risk reduction per \$1 billion** (Section 2)
- a direct judgment of what the historical portfolio plausibly accomplished, net of offsetting channels (Section 3)

We then divide the resulting risk reduction by the effectiveness-weighted spending behind it to get the cost per unit of risk reduction (Section 4). The risk reduction itself is the main estimate; the cost figure is a way to express it per dollar.
...
So if historical AI safety spending achieved only **0.01 percentage points per \$1B** (1 bp) or less, it was relatively weak by longtermist standards; if it achieved **0.5+ percentage points per \$1B** (50+ bp), it was unusually strong. These tiers inform the estimate below, but they do not measure the realized historical portfolio. We also give the EA Forum benchmarks somewhat reduced weight: they were written inside a community already unusually convinced of longtermist interventions.
