...
The cause writeup currently assumes chickens have about one-third of the welfare range of humans, based on Rethink Priorities' sentience-adjusted estimate. That makes the default `costPerQALY` about 3x worse than a human-equal weighting would imply.
