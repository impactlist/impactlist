...
- **Cost per QALY:** \$117,000 (\$35,000–\$2,000,000)
- **Start time:** 1 year
- **Duration:** 10 years
...
:::details{title="Why we use $120,000/QALY for public cultural institutions"}
...
A rough way to read **\$120,000/QALY** is: each \$1 creates about 0.0000083 QALYs, or about 4.4 quality-adjusted minutes. That can happen through many small experiences across many people: better performances, cheaper access, longer opening hours, educational programs, or keeping a public collection available.

This is not pinned down by a direct cost-effectiveness study. DCMS/Frontier supports the direction of the claim: broad cultural engagement has wellbeing value, but evidence is weaker and less intervention-like than the targeted participation evidence. We use a wide **\$40,000–\$1,000,000/QALY** plausible range because the same label covers free public libraries and museums on one end, and donor-supported elite cultural production on the other.
:::

:::details{title="Why we use $250,000/QALY for heritage, capital, and endowment-heavy gifts"}
...
A favorable mix might be **15% targeted participation at \$10,000/QALY**, **70% public cultural institutions at \$50,000/QALY**, and **15% heritage/capital at \$100,000/QALY**:

$$
\frac{1}{\frac{0.15}{\$10{,}000} + \frac{0.70}{\$50{,}000} + \frac{0.15}{\$100{,}000}}
\approx \$33{,}000/\text{QALY}
$$

That is why the low end is around **\$35,000/QALY** rather than \$15,000/QALY. Even a favorable broad-category donor mix is not usually all targeted participation, and hitting all the favorable inputs at once is a demanding joint case.

A weak mix might have **0% targeted participation**, **30% public cultural institutions at \$1,000,000/QALY**, and **70% heritage/capital at \$3,000,000/QALY**:

$$
\frac{1}{\frac{0.30}{\$1{,}000{,}000} + \frac{0.70}{\$3{,}000{,}000}}
