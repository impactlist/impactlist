...
_The following analysis was done on April 6th 2026, written by Codex and edited by Impact List staff for clarity._
...
Coulton reports direct delivery and training costs of **£176.84 per session** for the choir intervention. Over 14 sessions that is about **£2,476 per group**. Using roughly **12 regular participants** as a midpoint implies direct delivery cost of about **£206 per participant** before adding the kinds of costs real donor-funded programmes often face: referral infrastructure, outreach, retention support, transport help, venue slack, safeguarding, evaluation, management, and general charity overhead.

That pushes the total donor cost toward about **\$350 per completed participant-course**, with a plausible range of **\$175-\$600** (Assumption 7). This is not a deliberate upward bias; it reflects the fact that a donor funds a whole operating charity, not just facilitator time in the room, and published social prescribing evaluations often omit some of those non-medical and voluntary-sector costs.
