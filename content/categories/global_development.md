...
This effect captures welfare gains from donations to unusually effective charities that help people in extreme poverty become materially better off, especially through large unconditional cash transfers and related "big push" livelihood interventions. The main benefits are higher consumption, greater asset ownership, better food security, improved psychological wellbeing, and in some cases lower child mortality. We mostly leave interventions whose main value comes from preventing disease or death to the Global Health category. We also do not model broad economy-wide growth effects here.

## What kinds of charities are we modeling?

These estimates are for **direct poverty-relief and livelihood programs with strong evidence**, especially large unconditional cash transfers and graduation-style "big push" interventions.

They are not meant for microfinance, broad foundations, education-adjacent programs, or general economic-development institutions unless a recipient-specific model shows a comparable route from donor dollars to consumption or welfare gains.
...
The graduation literature is one reason not to go much shorter than 10 years, because some "big push" interventions really do seem to create durable changes in assets, occupation, and income. But this site's model spreads benefits evenly across the duration window, and cash-transfer benefits are front-loaded rather than flat. So **10 years** approximates the actual timing of benefits better than **15 years** does.
