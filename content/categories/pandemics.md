...
Unlike a "normal" cause where we estimate cost per QALY, donations to pandemic charities aim to avert a low-probability but extremely serious event. We define such an event, estimate how many people it would affect and harm, and estimate the cost of reducing its probability by one in a million.
