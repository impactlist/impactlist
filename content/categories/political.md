...
We estimate **\$20,000/QALY** for strong political giving. The driver is a four-link chain: a well-targeted gift nudges win probability, the contest is sometimes pivotal for a welfare-relevant policy wedge, and that wedge converts to QALYs at a rate far worse than direct giving. All four parameters are cruxes, especially the size of the policy wedge and how often a contest is genuinely pivotal. Each can move a lot, and they tend to move together with your overall view of political leverage, so the plausible range is wide (\$5,000–\$120,000/QALY).
...
**System-level dollars.** Daroudi et al. estimate **cost per DALY averted** of around **\$998** in low-HDI countries and **\$6,522** in medium-HDI countries — a useful outside-view check for what a more system-level health dollar can look like once you move away from handpicked top interventions.
...
If you back a race that turns out not to matter for chamber control, veto power, or a key ballot measure, the true pivotality can be near zero. But if you are funding unusually high-leverage opportunities, that should not be the average case. In a narrowly divided legislature or a closely fought statewide race, one contest can matter a lot:
...
Pushing all four parameters to their favorable extremes at once gives about \$3,100/QALY, and all to their unfavorable extremes gives about \$270,000/QALY. That corner is far wider than the plausible range: four roughly independent parameters rarely all land at one extreme together, so the published range sits well inside it. We then widen back out from the independent baseline for two reasons. First, the parameters are positively correlated — an optimistic read of how much leverage political money has tends to raise win probability, pivotality, and the wedge while lowering the conversion rate all at once. Second, the model carries structural uncertainty beyond these four levers, including the choice to scope the wedge to one narrow program family and the risk that other donors offset a marginal gift. That lands us at the **\$5,000-\$120,000** range, with a wider upside tail reflecting the chance that a genuinely pivotal contest is attached to a large policy wedge.
