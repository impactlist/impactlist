...
We estimate \$600/QALY, driven overwhelmingly by the added life. We divide a central cost of about \$45,000 per additional wanted birth (Assumptions 2-4) by the QALYs that birth produces, which we put at 75: 73 from the added person's own life (Assumption 5) plus modest allowances for parental wellbeing and broader spillovers (Assumptions 6-7). Three cruxes drive the result. Does population ethics count an extra good life as a large welfare gain? Can research and advocacy organizations really cause births at the cost the policy and fertility-care evidence implies? And how large are the secondary effects?
...
Read this as the cost of actually causing one more wanted birth, not the cost of serving one family or publishing one piece of research. For research and policy organizations, the crucial question is whether their indirect route to policy change beats or at least approaches the direct public-policy benchmarks above. The central estimate assumes advocacy and evidence-building have enough leverage to offset their indirectness. If they mostly fail to move policy, the cost per additional birth can be many times worse than the direct-policy anchor. Using those public-policy and fertility-care anchors is still better than pretending there is a precise philanthropy-specific estimate. ([Milligan 2002](https://www.nber.org/papers/w8845), [e61 Institute](https://e61.in/how-financial-incentives-shape-fertility-in-australia/), [Agha, Chorniy, and Canaan 2024](https://www.nber.org/papers/w32445), [Hoorens et al. 2024](https://academic.oup.com/humrep/article/39/5/981/7618943))

### 5. The added person's own life is worth about 73 QALYs on average

In high-income countries, life expectancy is about **81 years**. Value those years at about 0.9 QALYs each on average, and the added person's own life is worth roughly **73 QALYs**. That is the core moral driver of this estimate. The plausible range is about **50-80**: the low end reflects lower quality-of-life weights or shorter realized lifespans, the high end near-full valuation of a long life.
...
We set the range wider than treating those two inputs as independent would imply, for two reasons. First, they are positively correlated. A worldview pessimistic about pronatal philanthropy tends to pair a high cost per birth with a lower QALY valuation of the added life, and an optimistic worldview pairs the favorable ends. That correlation pulls the interval outward. Second, large structural uncertainties sit outside both parameters. The biggest is whether research and advocacy organizations can cause births at policy-benchmark cost at all. Another is the population-ethics premise that creating a good life is a large welfare gain: if you reject it, you would assign a far worse number than any value in the QALY sweep. We widen the upper (worse) bound much more than the lower because both of those structural risks push in the same pessimistic direction.
...
3. **Population ethics.** The estimate assumes that bringing an additional person with a good life into existence is a substantial welfare gain. If you reject that premise, assign a much lower value.
