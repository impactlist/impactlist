...
Forbes profile API accessed June 2026 lists "Lynn Schusterman & family" with real-time worth around $4.45B, 2026 Billionaires list value $4.4B, birth date 1939-01-21, and `deceased: false`.

The donation rows here credit Lynn 1.0 because Charles Schusterman died in 2000, the foundation remained centered on Lynn as founder/chair/chair emerita, and the public Forbes profile attributes the post-sale foundation funding to Lynn Schusterman & family. Stacy Schusterman may have contributed to later family-foundation top-ups, but without donor-level Schedule B data the file records observable inflows into Lynn's named family foundation and flags that uncertainty in notes.
