...
Michael Dell is living as of this 2026-06-11 pass.

Net worth uses the Bloomberg Billionaires Index estimate reported by Investopedia in early June 2026, after Dell Technologies shares rallied. Forbes and Bloomberg estimates moved quickly around late May and early June 2026, so this should be refreshed on the next maintenance pass.

Susan Dell is not given a separate donor file in this pass, consistent with the add-donor spouse default and the requested file scope. Joint Michael and Susan Dell household/foundation gifts are credited fully to Michael here, with Susan named in row notes.
