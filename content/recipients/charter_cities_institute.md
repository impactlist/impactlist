...
2.  **The Probability Discount:** Establishing a new city is significantly riskier than the typical institutions intervention. We assume CCI projects are roughly 4x less likely to produce a major durable win than the baseline category's scenario-weighted mix, because CCI depends on third-party city projects, governments, investors, and residents all coordinating successfully. {{CHALLENGE_ASSUMPTION:2}}
3.  **Execution Friction and Attribution:** We apply a further **0.4x** haircut for the difficulty of translating research and technical assistance into durable, politically accepted, welfare-improving city governance, and for the fact that CCI is usually one contributor among many. {{CHALLENGE_ASSUMPTION:3}}
4.  **Catch-up Growth:** Successful charter cities in LMICs have higher potential growth rates (7-10%) compared to rich-country cities (2-3%), which partially offsets the lower probability of success. {{CHALLENGE_ASSUMPTION:4}}
5.  **Direct Evidence Is Thin:** This is a hits-based override rather than a measured CCI effect. The range extends back toward the institutions default, and well above it, if CCI is rarely causal for durable institutional improvements. {{CHALLENGE_ASSUMPTION:5}}
