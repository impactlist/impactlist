...
- **Cost per QALY:** \$1,600 (\$500-\$50,000)
...
1.  **Low Marginal Cost (The Software Arbitrage):** The primary driver is the cost structure. The baseline relies on human labor (advisors/teachers), costing ~\$5,000-\$15,000 per successful outcome. Khan Academy supports very large numbers of learners on a software platform, so a reasonable all-in delivery cost is about **\$5 per active learner**. This is order-of-magnitude, not exact: Khan Academy's recent filing reports expenses in the high tens of millions, while its annual report describes well over 100 million learners. ([ProPublica](https://projects.propublica.org/nonprofits/organizations/261544963), [Khan Academy annual report](https://www.annualreport.khanacademy.org/)) {{CHALLENGE_ASSUMPTION:1}}
2.  **Intensity Discount:** Watching videos is a weaker intervention than 1-on-1 coaching. We assume roughly 1 in 400 active Khan Academy users achieves a counterfactual life outcome comparable to the baseline intervention, versus about 1 in 4 for intensive advising. That is a 1% relative success-probability ratio. {{CHALLENGE_ASSUMPTION:2}}
3.  **Global South Premium:** Unlike the baseline (US/UK focus), Khan Academy reaches a global user base, including significant usage in LMICs. Income gains in these regions convert to QALYs at a higher rate under logarithmic utility, so we apply a conservative 2x valuation boost. {{CHALLENGE_ASSUMPTION:3}}
4.  **Attribution and Substitution:** We apply a modest 0.8x adjustment for substitution and attribution risk. We keep it small because the 1-in-400 success assumption already accounts for most of the low-dosage, low-compliance, and user-churn concern. {{CHALLENGE_ASSUMPTION:4}}

## Details

### Deriving the \$1,600/QALY estimate

We benchmark Khan Academy against the education category estimate of **\$25,000/QALY** and compare it to a portfolio of high-touch education interventions.
...
Applying the 16x relative-efficiency estimate to the education baseline gives:
