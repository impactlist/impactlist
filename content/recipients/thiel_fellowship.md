...
We calculate the cost-effectiveness multiplier ($M$) by comparing the expected value of the Thiel Fellowship ($EV_{TF}$) against Standard Education Charities ($EV_{Base}$).

$$M = \frac{EV_{Base}}{EV_{TF}}$$

We analyze the Expected Value ($EV$) of a $100,000 investment in both scenarios.

### 1. Baseline: Standard Scholarship ($EV_{Base}$)
...
### 2. Intervention: Thiel Fellowship ($EV_{TF}$)
...
$$\text{Relative Effectiveness} = \frac{EV_{TF}}{EV_{Base}} = \frac{\$10,000,000}{\$400,000} = 25$$
