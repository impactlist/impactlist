...
const MARKDOWN_VARIABLES = {
  ...
  RECIPIENT_DEFAULT_JUSTIFICATION: `The cost per life of this recipient is assumed to be the same as for the baseline for each of its categories.
You can see how these cost per life values were calculated by going to the pages of its associated categories (see above).`,
};
