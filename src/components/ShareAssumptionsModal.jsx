...
const ShareAssumptionsModal = ({
  ...
  return (
    <ModalShell isOpen={isOpen} onClose={onClose} labelledBy="share-assumptions-modal-title">
      <ModalHeader title={title} titleId="share-assumptions-modal-title" onClose={onClose} />
