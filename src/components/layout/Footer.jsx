  ...
  return (
    ...
    >
      <div className="flex justify-center items-center space-x-6">
        ...
        <a href="https://discord.gg/6GNre8U2ta" target="_blank" rel="noopener noreferrer" className={SOCIAL_LINK_CLASS}>
          <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        <a href="https://x.com/impactlist_" target="_blank" rel="noopener noreferrer" className={SOCIAL_LINK_CLASS}>
          <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
